              ...
              <View style={styles.CreditCardBG}>
                <LinearGradient
                  ...
                  <View style={styles.CreditCardNumberContainer}>
                    ...
                    <Text style={styles.CreditCardNumber}>8426</Text>
                    <Text style={styles.CreditCardNumber}>5218</Text>
                    <Text style={styles.CreditCardNumber}>2497</Text>
                  </View>
                  <View style={styles.CreditCardRow}>
                    <View style={styles.CreditCardNameContainer}>
                      ...
                      <Text style={styles.CreditCardNameTitle}>Jhon Dee</Text>
                    </View>
